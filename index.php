...
<head>
    <title>Edureka Cold Storage</title>
    <meta charset="utf-8">
  ...
  margin: 25% auto; /* Gives that scrolling effect as the typing happens */
  letter-spacing: .15em; /* Adjust as needed */
  animation: 
    typing 6.5s steps(78) infinite,
    blink-caret .75s steps(2) infinite;
}
                ...
                <div class="container">
                    <a class="navbar-brand" href="#">
                        <img src="images/iconLogo.png" width="30" height="30" class="d-inline-block align-top"
                            alt=""><span class="mt-4">Storages</span>
...
<div class="container-fluid" style="background-color:lightcoral">
    ...
    <div class="jumbotron jumbotron-fluid">
        ...
        <div class="section">
        <h1>Welcome to Edureka Cold Storage</h1>
        </div>
        </div>
        </div>
                    ...
                    ?>
                        <tbody class="tbody">
                            <tr>
                                ...
                                <td>
                                    <a href="bookStorage.php?sid=<?php echo $id; ?>&uid=<?php echo $uid; ?>" class="btn btn-success"><i
