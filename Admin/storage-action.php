        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="app-stats text-center mt-3"
                    style="color:black;font-family: 'Times New Roman', Times, serif;">Storage Details</h2>
                <div class=" table-responsive">
                    <table class="table table-striped table-hover">
                       ...
                       while($Datarows = $stmt->fetch_assoc())
                       {
                           ...
                           $cons        = $Datarows['consumed'];
                           $remains     = $Datarows['remains'];    
                    ?>
                        <tbody class="tbody">
                            <tr>
                                <td>#<?php echo  $id;       ?></td>
                                ...
                                <td> <?php echo  $qty;      ?></td>
                                <td> <?php echo  $cons;    ?></td>
                                <td> <?php echo  $remains;    ?></td>
                                 <td>
                                     <a title="Edit This Storage" href="edit-storage.php?id=<?php echo $id; ?>" class="btn btn-warning"><i class="fas fa-edit"></i>
                                    </a> 
